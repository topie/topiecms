...
<div class="container">
    <div class="row">
        <div class="col-md-6 hd-logo">
            <a href="index.html" class="thumbnail thumbnails">
                <img src="img/jinhu.png">
            </a>
        </div>
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-11 col-lg-offset-2 col-lg-10">
                    <div class="row hd-pd text-center">
                        <div class="col-xs-2"><a href="#" class="thumbnail thumbnails"><img src="img/phone.png"></a></div>
                        <div class="col-xs-2"><a href="#" class="thumbnail thumbnails"><img src="img/phone1.png"></a></div>
                        <div class="col-xs-2"><a href="#" class="thumbnail thumbnails"><img src="img/weibo.png"></a></div>
                        <div class="col-xs-2"><a href="#" class="thumbnail thumbnails"><img src="img/weixin.png"></a></div>
                    ...
                    <div class="input-group hd-btn">
                        <input type="text" class="form-control ht3em" placeholder="请输入要查找的关键词">
...
<div class="nav-bg">
    <div class="container mgb0">
        <div class="nav-list fontSize18 text-center clearfix row">
            <div class="col-xs-4 col-sm-2 current"><a href="index.html">首页</a> </div>
            <div class="col-xs-4 col-sm-2"><a href="mljh.html">美丽金湖</a> </div>
            <div class="col-xs-4 col-sm-2"><a href="xwzx.html">新闻中心</a> </div>
            <div class="col-xs-4 col-sm-2"><a href="zwgk.html">政务公开</a> </div>
            <div class="col-xs-4 col-sm-2"><a href="ggfw.html">公共服务</a> </div>
            <div class="col-xs-4 col-sm-2"><a href="zmhd.html">政民互动</a> </div>
        </div>
    </div>
</div>
    ...
    <div class="jh-main">
        ...
        <div class="">
            <div class="index-toff border-gray1">
                ...
                <#if code??>
                <#if code="1">
                <a href="#" class="index-ton fontSize30">县领导信箱</a>
                
                 <#elseif code="2">
                <a href="#" class="index-ton fontSize30">书记信箱</a>
                
                <#else>
                <a href="#" class="index-ton fontSize30">镇或部门信箱</a>
                </#if>
                </#if>
            </div>
            <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-offset-2 col-sm-8 col-lg-offset-3 col-lg-6 text-center fontSize16">
                <div class="row ft-pd">
                    <div class="col-xs-3"><a href="#" target="_blank">关于我们</a><span class="ft-line">|</span></div>
                    <div class="col-xs-3"><a href="#" target="_blank">网站地图</a><span class="ft-line">|</span></div>
                    <div class="col-xs-3"><a href="#" target="_blank">在线投稿</a><span class="ft-line">|</span></div>
                    <div class="col-xs-3"><a href="#" target="_blank">联系我们</a></div>
                </div>
            </div>
        </div>
        <div class="row ft-pd1">
            ...
            <div class="col-md-8 text-center">
                <p class="mgt10"><span>&nbsp; 金湖县人民政府主办 &nbsp;</span><span>&nbsp; 金湖县互联网信息中心承办 &nbsp;</span></p>
                <p><span>&nbsp; 地址：江苏省金湖县建设路109号（县行政中心大楼）&nbsp;</span><span>&nbsp; 热线：0517--86812345&nbsp;</span></p>
