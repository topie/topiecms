	    ...
	    <link href="/html/jinhu-static/css/style.wq1.css" rel="stylesheet">
	     ...
	     <![endif]-->
           ...
           <#include "/template/jh-index-daohang.ftl">
            ...
            <div class="attention">
            	<p>说明事项</p>
                <p>1、首先感谢您对金湖的建设和发展提出宝贵意见和建议，欢迎您今后继续 对我们的工作提出建议。</p>
                <p>2、请您务必遵守中国相关法律和法规，不得填写具有骚扰、中伤、辱骂、恐吓、诽谤、伤害、色情、反动、迷信、危害国家安全等色彩的非 法信息。</p>
                <p>3、方框后加“*”号的为必填项，提交信件时不能为空白。</p>
                <p>4、您在投诉、举报时，请务必留下真实而具体的姓名、联系方式，并详细提供有关情况，以便于有关部门进行核实处理，我们会为您的个人 资料严格保密。</p>
                <p>5、请您牢记信件提交后网站反馈给您的“信件编号”和“信件密码”，以便于查询信件办理进展情况和结果。</p>
                <p>6、如果您不清楚部门的机构职能，请点击网站首页左侧的“机构职能”进行查询。</p>
                <p>7、请您不要一信多投，也不要重复投信。</p>
            </div>
        </div>
    </div>
           		<!--相关链接-->
