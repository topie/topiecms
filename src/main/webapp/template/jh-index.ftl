<!DOCTYPE html>
                           			    ...
                           			    <@contentListDirective channelId=211 pageSize=4 pageNum=1  order=10>
                           			     <#list contents as cmsContent>
                           			      <div class="item ${(cmsContent_index==0)?string('active','')}">
                                                                     <a href="${cmsContent.url}" ><img src="${cmsContent.titleImageUrl!}"/></a>
                           					  <div class="carousel-caption carousel-caption1">
                                                                         <p><a href="${cmsContent.url}" style="color:white;">${cmsContent.title}</a></p>
                                                                       </div>
                                                           </div>
                           				</#list> 
                           			    ...
                           			    <@channelDirective channelId=19>
                           				 ...
                           				 <div class="col-xs-9 fontSize14">
                                               ...
                                               <div class="col-md-5 pdTop1em">
                                                 <@contentListDirective channelId=17 pageSize=1 titleLeft=17 order=2>
           			  <#list contents as cmsContent>
           			<a href="${cmsContent.url}" target="_blank"><p class="fontSize22 color-green">${cmsContent.title!}</p></a>
                                                   ...
                                                   <div>
                                                       <!-- Nav tabs -->
                           			    <@channelListDirective channelId=4 order=4 excludeIds="17,18,19,211">
                                   ...
                                   <a href="#" class="thumbnail thumbnails thumbnails1">
                                       <img src="/html/jinhu-static/img/index_pic1.png">
                                   </a>
                                   <div class=""><!--政务公开-->
                                       <div class="index-toff border-gray1">
                                           <a href="#" class="index-ton color-green fontSize30">政务公开</a>
                                       </div>
                                       <div class="row">
                                           <div class="col-md-3">
                                               <div class="panel panel-default panel1">
                                                   <div class="panel-heading panel1-t"><a href="#" class="panel1-ton fontSize18">基本政务信息</a></div>
                           			...
                           			<@channelDirective channelId=29>
                                           ...
                                           <div class="col-md-4 pdTop1em">
                                               <div class="panel panel-default panel1">
                                                   <div class="panel-heading panel1-t"><a href="#" class="panel1-ton fontSize18">重点政务信息</a></div>
                                                   <div class="panel-body">
                                   ...
                                   <a href="#" class="thumbnail thumbnails thumbnails1">
                                       <img src="/html/jinhu-static/img/index_pic2.png">
                                   </a>
                                   <div class="">
                                       <div class="index-toff border-gray1">
                                           <a href="#" class="index-ton color-green fontSize30">公共服务</a>
                                       </div>
                                       <div class="row">
                                           <div class="col-md-9">
                                               <div class="panel panel-default panel1">
                                                   <div class="panel-heading panel1-t"><a href="#" class="panel1-ton fontSize18">政务大厅</a></div>
                                                   <div class="panel-body">
                                                       <div class="row">
                                                           <div class="col-md-4">
                                           ...
                                           <div class="col-md-3">
                                               <div class="panel panel-default panel2">
                                                  ...
                                                  <@channelDirective channelId=41>
                                                       <div class="color-green pd3 dis-b"><span class="mgr10"><img src="/html/jinhu-static/img/index_zytd_icon1.png"></span>${channel.displayName}</div>
                                              </@channelDirective>
                           			     ...
                           			     <@channelListDirective channelId=41 order=4>
                                          			<#list channels as channel>
                                                       ...
                                                       <div class="color-green pd3 dis-b"><span class="mgr10"><img src="/html/jinhu-static/img/index_zytd_icon2.png"></span>绿色通道</div>
                                                       <div class="index-zttd-list clearfix fontSize12">
                                   ...
                                   <a href="#" class="thumbnail thumbnails thumbnails1">
                                       <img src="/html/jinhu-static/img/index_pic3.png">
                                   </a>
                                   <div class="">
                                       <div class="index-toff border-gray1">
                                           <a href="#" class="index-ton color-green fontSize30">政民互动</a>
                                       </div>
                                       <div class="row">
                                           <div class="col-md-4">
                                               <div class="panel panel-default panel1">
                           		    <@channelDirective channelId=51>
                                                   <div class="panel-heading panel1-t"><a href="csgk.html" class="panel1-ton fontSize18">${channel.displayName}</a></div>
                                                   <div class="panel-body">
                                                       <a href="${channel.url}" target="_blank" class="thumbnail thumbnails thumbnailb">
                                                           <img src="/html/jinhu-static/img/index_zxft_pic.png">
                                                       </a>
                           				<ul>
                                          			<@videoListDirective channelId=51 pageSize=1 pageNum=1 >
                                          				<#list cmsVideos as video>
                                          				    <li><span class="jh-dotted">·</span>主题： ${video.name}</li>
                                          				    <li><span class="jh-dotted">·</span>嘉宾：   ${video.actor}</li>
                                          				    <li><span class="jh-dotted">·</span>时间：   2016年7月14日 9时30分—11时00分</li>
                                          				</#list>
                                          			</@videoListDirective>
                           				</ul>
                                                           </div>
                           			...
                           			<li role="presentation"><a href="#lxhf" aria-controls="lxhf" role="tab" data-toggle="tab" aria-expanded="true">来信回复</a></li>
                                                   ...
                                                   <div class="tab-content navTab1-content navTab3-content pTextIndent">
                                                       <div role="tabpanel" class="tab-pane active" id="wsdc">
                                                           <ul class="panel2-list">
                           				<@contentListDirective channelId=52 pageSize=9 pageNum=1 order=10>
                           				<#list contents as cmsContent>
                           					<li><span class="jh-dotted">·</span><a href="${cmsContent.url}" target="_blank">${cmsContent.title}</a></li>
                           				</#list> 
                                          			</@contentListDirective>
                                                       ...
                                                       <div role="tabpanel" class="tab-pane" id="myzj">
                                                           <ul class="panel2-list">
                                                               <@contentListDirective channelId=53 pageSize=9 pageNum=1 order=10>
                           				<#list contents as cmsContent>
                           					<li><span class="jh-dotted">·</span><a href="${cmsContent.url}" target="_blank">${cmsContent.title}</a></li>
                           				</#list> 
                                          			</@contentListDirective>
                                                       ...
                                                       <div role="tabpanel" class="tab-pane" id="zjfk">
                                                           <ul class="panel2-list">
                                                              <@contentListDirective channelId=54 pageSize=9 pageNum=1 order=10>
                           				<#list contents as cmsContent>
                           					<li><span class="jh-dotted">·</span><a href="${cmsContent.url}" target="_blank">${cmsContent.title}</a></li>
                           				</#list> 
                                          			</@contentListDirective>
                                                       ...
                                                       <div role="tabpanel" class="tab-pane" id="lxhf">
                                                           <ul class="panel2-list">
                                                               <@contentListDirective channelId=50 pageSize=9 pageNum=1 order=10>
                           				<#list contents as cmsContent>
                           					<li><span class="jh-dotted">·</span><a href="${cmsContent.url}" target="_blank">${cmsContent.title}</a></li>
                           				</#list> 
                                          			</@contentListDirective>
