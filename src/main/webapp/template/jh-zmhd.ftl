<!DOCTYPE html>
       	...
       	<#list cmsVotes as  v>
            ...
            <li class="htAuto"><span class="jh-dotted">·</span><a href="${v.filed1}">${v.desc!}</a></li>
       	</#list>
                          ...
                          <div class="borderTop clearfix"> <a href="jjfz.html" class="color-green fontSize18 pd2 dis-b">下期预告</a>
                            <ul class="panel2-list panel2-list-sm">
                              <li><span class="jh-dotted">·</span><a href="#">央视新闻联播头条聚焦金湖</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="border-gray">
              		 ...
              		 <@channelDirective channelId=53><!---->
                                         <li role="presentation" class=""><a href="#zrdl" aria-controls="zrdl" role="tab" data-toggle="tab">${channel.displayName}</a></li>
                 		 </@channelDirective><!---->
