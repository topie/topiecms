             ...
             <div class="container bg-white">
             	...
             	<@channelDirective channelId=12><!--政务要闻-->
             		...
             		<@channelDirective channelId=16><!--视频新闻-->
                                 ...
                                 <div class="panel-body">
                                     <ul class="panel2-list panel2-list-pd">
             			<@videoListDirective channelId=channel.id pageSize=7 titleLeft=30 order=4>
             			  <#list cmsVideos as cmsContent>
             			  <li><a target="_blank" href="${cmsContent.url}"><span class="panel2-list-content">${cmsContent.name}</span><span class="panel2-list-time">${cmsContent.publishDate?string("yyyy-MM-dd")}</span></a></li>	
             			  </#list>
             			  </@videoListDirective>
                                        </ul>
                                 </div>
               	...
               	<@channelDirective channelId=12><!--政务要闻-->
               		  <div class="panel-heading panel1-t"><a href="${channel.url}" target="_blank" class="panel1-ton fontSize18">${channel.displayName}</a></div>
               			<div class="panel-body">
                               <div class="row">
                                   <div class="col-md-5">
                                   <@contentListDirective channelId=211 pageSize=1 titleLeft=17 order=1>
               			  <#list contents as cmsContent>
                            <a href="${cmsContent.url}" target="_blank" class="thumbnail thumbnails thumbnailb">
