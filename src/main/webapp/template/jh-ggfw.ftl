       ...
       <#include "/template/jh-daohang2.ftl">
      	...
      	<@channelDirective channelId=38>
              ...
              <div class="row text-center fontSize16">
                  <div class="col-md-4">
                      <div class="ggfw-list-bg">
                        ...
                        <a href="${channel.url}" style="color:white;">
            ...
            <@channelDirective channelId=41>
              <div class="color-green fontSize18 pd5 dis-b">${channel.displayName}</div>
              </@channelDirective>
              <div class="row">
                  <div class="col-md-9">
                      <div class="clearfix">
      		   ...
      		   <#list channels as channel>
      			...
      			<!-- Nav tabs -->
      				...
      				<li role="presentation" class="${(childchannel_index==0)?string('active','')}">
      					<a href="#child${childchannel_index}" aria-controls="child${childchannel_index}" role="tab" data-toggle="tab" aria-expanded="true">${childchannel.displayName}</a></li>	
      				</#list>
      			   </ul>
                                  <!-- Tab panes -->
                                  <div class="tab-content navTab1-content navTab3-content pTextIndent">
      			    <#list channels as childchannel>
                                      <div role="tabpanel" class="tab-pane active" id="child${childchannel_index}">
                                          <ul class="panel2-list">
      					<#list channels as childchannel>
      						<@contentListDirective channelId=childchannel.id>
      						<#list contents as content>
      						<li><span class="jh-dotted">·</span><a href="${content.url}">${content.title}</a></li>
      						</#list>
      		...
      		<#list channels as cchannel>
                          <div class="col-xs-3">
                              <a href="${cchannel.url}" class="thumbnail thumbnails text-center">
